...
Iteration 4: Put widgets in the score frame. You will be 
adding labels (for “Score” and “Game over”), 
and frames with labels inside for “Points”, “Time”, 
and “Points per sec”. There was not a corresponding 
frame in the game of life, but these widgets you’ve 
worked with before. Be sure to position them as 
you see them in the pictures above. The program for 
this iteration should be in a file named snake4.py.
"""
import random
...
class SnakeView:
    ...
    def add_scoreboard(self):
        ...
        #create points per second label/frame
